		...
		<div id="content">
			<div class="content-top">
				<div class="content-trail">
                    ...
                    <li><a href="../media.php" rel="np"><?php echo $website['Media']; ?></a></li>
                    <li><a href="videos_index.php" rel="np"><?php echo $website['Videos']; ?></a></li>
                	<?php
				...
				<div class="content-bot">	
						...
						<div id="media-content" class="film-strip-wrapper">
									...
									if($error == 0){
										...
										if(isset($_POST['vali'])){
											...
											echo '<meta http-equiv="refresh" content="1;url=videos_visor.php?id='.videos_id.'"/>';
											$show_comment=false;
										}else{				
					...
					<div>
                    <table width="940">
                    <tr><td width="40"></td><td width="860" height="40"><font color='#7F7231'>Fecha:</font><font color='#C09A67'><?php echo $videos['date']; ?></font></td><td width="40"></td></tr>
					<tr><td width="40"></td><td width="860"><font color='#C09A67'><?php echo $videos['description']; ?></font></td><td width="40"></td></tr>
                    <tr><td width="40" height="40"></td><td width="860" valign="bottom"><span style="font-size:20px; font-family:Verdana,Geneva,sans-serif;"><?php echo $comments['comments']; ?>(<?php echo $videos['comments']; ?>)</span></td><td width="40"></td></tr></table>
								...
								<div id="page-comments">
									<div class="page-comment-interior" id="comments">
															...
															<div class="content">
																...
																<div class="action">
																	...
																	<div class="cancel">
																				...
																				<a href="javascript:;" onClick="$('#comment-form-reply').slideUp();"><?php echo $Media['Cancel']; ?></a>
																	</div>
										...
										$get_comments = mysql_query("SELECT * FROM video_comments WHERE videoid = '".$videos['id']."' ORDER BY DATE asc");
