...
<div class="header-plate">
      ...
      ?>
			...
			<li class="menu-forums"><a href="http://sgochile.crearforo.com" <?php if($page_cat=='forums') echo'class="menu-active"';?>><span><?php echo $Forums['Forums']; ?></span></a></li>
			...
			<li class="menu-forums"><a href="<?php echo $website['root']; ?>http://sgochile.crearforo.com"<?php // forum/ ?>><span><?php echo $Forums['Forums']; ?></span></a></li>
