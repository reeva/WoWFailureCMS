<div id="header">
	...
	<div class="header-plate-wrapper">
      ...
      ?>
			...
			<li class="menu-game"><a href="<?php echo $website['root']; ?>media.php" <?php if($page_cat=='media') echo'class="active"';?>><span><?php echo $Media['Media']; ?></span></a></li>
			...
			<li class="menu-media"><a href="<?php echo $website['root']; ?>status.php" <?php if($page_cat=='game') echo'class="active"';?>><span><?php echo $status['status']; ?></span></a></li>
