...
<div id="forum-content">
				...
				<tr>
					...
					<div class="post-user">';
						...
						<div class="character-info">
							...
							<div>';
							if($char['val'] == 1){
							echo '<div class="character-desc"><span class="color-c5">'.$char['level'].' '.race($char['race']).' '.classx($char['class']).'</span></div>
					...
					if($thread['locked'] == 1){
						if($userInfo['class'] != ""){
							...
							if($thread['author'] == $userInfo['id']){
								echo'<a xmlns="http://www.w3.org/1999/xhtml" class="ui-button button2 " href="#"><span><span>Edit</span></span></a>';
							}
							echo '<a class="ui-button button2 " href="#new-post">
				...
				if(isset($_SESSION['username'])){
					if($thread['locked'] == 1){
						if($userInfo['class'] != ""){
							...
							echo'<a class="ui-button button2 " href="#"><span><span>Edit</span></span></a>';
							}
							echo'							
		...
		<center>Post Created...<br /><br /><div class="loader"> </div><br />Redirecting...</center>
		<meta http-equiv="refresh" content="1;url='.$website['root'].'forum/category/view-topic/?t='.$tid.'"/>
		';
		} ?>
