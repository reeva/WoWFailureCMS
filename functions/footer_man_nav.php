...
<li class="service-cell service-welcome"><?php echo $Welcome['Welcome']; ?><?php echo $globalInfoVar['Anonymous']; ?> | <a href="<?php echo $website['root'];?>logout.php"><?php echo $logout['logout']; ?></a></li>
<?php }else{ ?>
