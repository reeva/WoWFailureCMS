...
<div class="content-trail">
	...
	if(isset($_GET['f'])){
		...
		<li class="last"><a href="create-topic/?f='.$forumid.'" rel="np">New Topic</a></li>
		</ol>';
...
<div class="content-bot">    
    <?php if(isset($_POST['create'])){
		...
		if(empty($_POST['subject'])){ $errors[] = "Empty Thread Name"; }
		if(empty($_POST['detail'])){ $errors[] = "Empty Thread Content"; }
		...
		if(isset($errors) && count($errors) > 0){
			...
			$insert = mysql_query("INSERT INTO forum_threads (forumid,name,author,views,date,content,has_blizz,last_date) VALUES ('".$forumid."','".$subject."','".$author."','0','".$ndate."','".$content."','".$hb."','".$ndate."')")or print("Could not post the thread!");
			...
			echo '</div>';
			echo '<meta http-equiv="refresh" content="2;url=/forum/category/?f='.$forumid.'"';
		}
